...
return {
...

    {
        ...
        opts = {
            ...
            keywords = {
                ...
                TODO = { icon = "🧩", color = "default", alt = { "TODO_N", "TODO" } },
                HACK = { icon = "🧪", color = "warning" },
                WARN = { icon = "🧯", color = "warning", alt = { "WARNING", "WARN_N", "WARN" } },
...

    {
        ...
        keys = {
            { "<leader>ma", "<cmd>BookmarksAdd<CR>", desc = "Add Bookmark" },
            { "<leader>md", "<cmd>BookmarksDelete<CR>", desc = "Delete Bookmarks" },
            { "<leader>ml", "<cmd>BookmarksList<CR>", desc = "List Bookmarks" },
        },
        config = function()
            require("bookmarks").setup({
                ...
                virt_text_hl = "bookmarks_virt_text_hl",
            })
        end
    },
